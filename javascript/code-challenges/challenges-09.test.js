...
const maxInArray = (arr) => {
  // Solution code here...
  return arr.reduce((object, number) => {
    return (object = number > object ? number : object);
  });
};
...
You are given an object with names and their coresponding phone numberbers that looks like this:
{
...
const updatenumberbers = (obj) => {
  // Solution code here...
  return Object.entries(obj).map((object) => object.join(': '));
};
...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach((item) => {
    if (item.name === character) {
      let index = Object.keys(item).indexOf('children');
      if (index >= 0) {
        outCome
...
Write a function named totalCharacters that takes in an array and returns the numberber of characters in the array.
------------------------------------------------------------------------------------------------ */
...
Write a function named houseSize that takes in the array of characters and creates an object for each house containing the name of the house and the numberber of members.
...
This function should create an object for each house containing the name of the house and the numberber of members. If the spouse is deceased, do not include him/her in the total numberber of family members.
...
describe('Testing challenge 1', () => {
  test('It should return the maximum numberber found', () => {
    expect(maxInArray([4, 2, 7, 5, 9, 2])).toStrictEqual(9);
  });
  test('It should handle negatives and return the maximum numberber found', () => {
...
describe('Testing challenge 4', () => {
  test('It should return an an array of names and numberbers', () => {
    const startingObj = {
      'Grace Hopper': '222-303-5938',
      'Ada Lovelace': '222-349-9842',
      'Alan Turing': '222-853-5933'
    ...
    expect(updatenumberbers(startingObj).includes('Grace Hopper: 222-303-5938')).toBe(true);
  });
});
...
xdescribe('Testing challenge 8', () => {
  test('It should return the numberber of characters in the array', () => {
